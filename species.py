"""
speciation occurs when the first population is dead. 
its a process which splits the population into species based on similarities of their weighted conncections. 
